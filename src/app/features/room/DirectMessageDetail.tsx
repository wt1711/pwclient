...
import { AIAssistant } from '~/app/features/ai-assistant/dashboard/desktop-ui/AIAssistant';
...
export function DirectMessageDetail() {
  ...
  return (
    <PowerLevelsContextProvider value={powerLevels}>
      <RoomEditorProvider>
        <RoomMessageProvider>
          <Box grow="Yes">
            <RoomView room={room} eventId={eventId} messageOnly />
            {/* {isDesktop && isDrawer && (
              <>
